...
class all_articles:
    ...
    def medium_search(self, theme: str) -> list:
        ...
        response_json_string = response.text.split("APOLLO_STATE__ =")[1].split(
            "</script><middlewarestate>"
        )[0]
        # Turn the object into a python dictionary
        try:
...
all_articles_object.populate_all_collected_articles(
    ["science", "politics", "economics", "sports", "literature", "technology"],
    ["medium", "nytimes"],
)
end = time.time()
